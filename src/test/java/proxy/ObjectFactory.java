...
public class ObjectFactory {
    ...
    private final static QName _ConversionEuroToDh_QNAME = new QName("http://JWS/", "ConversionEuroToDh");
    private final static QName _GetCompteResponse_QNAME = new QName("http://JWS/", "getCompteResponse");
    private final static QName _GetCompte_QNAME = new QName("http://JWS/", "getCompte");
    private final static QName _ConversionEuroToDhResponse_QNAME = new QName("http://JWS/", "ConversionEuroToDhResponse");
    private final static QName _GetComptesResponse_QNAME = new QName("http://JWS/", "getComptesResponse");
    private final static QName _GetComptes_QNAME = new QName("http://JWS/", "getComptes");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "ConversionEuroToDh")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "getCompteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "getCompte")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "ConversionEuroToDhResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "getComptesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JWS/", name = "getComptes")
