 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://JWS/", wsdlLocation = "http://localhost:8080/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://JWS/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://JWS/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://JWS/", "BanqueWSPort"), BanqueWS.class, features);
    }
